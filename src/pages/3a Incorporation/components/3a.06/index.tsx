...
class MainForm extends React.Component<
    IShareholderProps & FormikProps<IFormValues & IShareholderDetails>,
    { occupied_shares: number }
> {
    constructor(
        props: IShareholderProps &
            FormikProps<IFormValues & IShareholderDetails>
    ) {
        super(props);
        this.state = {
            occupied_shares: 0
    ...
    public render() {
        return (
            <>
                <InnerForm
                    {...this.props}
                    emitValue={this.tslintNoEmptyFunction}
                    title="Shareholder information"
                    field="shareholder"
                    _innerhtml={this.props.shareholders.map((el, i) => {
                        return (
