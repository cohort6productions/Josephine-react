...
class MainForm extends React.Component<IProps & FormikProps<IFormValues & IPersonalDetails>, IShareholderState> {
            ...
            <div className="col-12 col-md-8 mx-auto">
                ...
                <div className="row">
                    ...
                    <div className="form-group col-12">
                        <button type="button" onClick={this.toggle} className="btn btn-default">+ Add a Director</button>
                    </div>
                        ...
                        this.props.shareholders.map((el, i) => {
                            return (
                                <div key={i} className="form-group col-12">
                                    ...
                                    {el.category === 'personal' ? el.firstname+' (Individual)' : el.companyname+' (Corporate)'}
                                    <button type="button" className="btn btn-default ml-auto" onClick={this.handleShareholder.bind(this, el)}>Add</button>
                                    </div>
                                </div>
                            )
                        })
                    ...
                    <Modal isOpen={this.state.modal} toggle={this.toggle} size="lg">
                        <ModalHeader toggle={this.toggle}>Director information</ModalHeader>
                        <ModalBody>
                            ...
                            <Row>
                                ...
                                <DirectorForm {...this.props} category={activeTab}/>
