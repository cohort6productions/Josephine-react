    ...
    <div className="container footer-upper">
        ...
        <div className="row">
            <div className="col-md-5 col-lg-7">
                <p>
                    Sign up to our newsletter for events, unique contents and
                    new services! We hate spam as much as you do, so we'll never
                    send you more emails than you want, and you can unsubscribe
                    at any time.
                </p>
            </div>
